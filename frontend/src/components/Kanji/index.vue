<template>
  <div>
    <Navbar />
    <a-row style="margin:2%" align="center" type="flex">
      <a-col :span="15">
        <SearchBar />
      </a-col>
    </a-row>
    <a-row style="margin:2%" type="flex" justify="space-around">
      <a-col :span="3">
...
export default {
  ...
  created: async function() {
    const kanji = this.$route.params.detailedKanji;
    const response = await getKanjiDetails(kanji);
